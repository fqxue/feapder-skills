...
- Use this file first when the main question is "which spider type or project shape should I choose?"
- After deciding the spider type, jump to the matching focused reference instead of opening the whole vendor snapshot.
- Open vendored templates only when you need exact startup or layout details.
