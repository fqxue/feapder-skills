...
- Use this file when the question is about config placement, debug workflow, or where to look upstream.
- Check the smallest relevant upstream file first.
- Open core source files only to confirm signatures, lifecycle hooks, or behavior not made clear by docs and tests.
